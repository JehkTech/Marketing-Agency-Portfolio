 ...
 * 
 * Design Strategy:
 * - Four-column layout for organization
...
export default function Footer() {
  ...
  const navigation = {
    ...
    social: [
      { name: 'Instagram', href: 'https://www.instagram.com/kinertic_marketing/', icon: 'instagram' },
  ...
  return (
    <footer className="bg-kinertic-black border-t border-white/10">
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-gray-500 text-sm">
              © {currentYear} Kinertic Media Arts. All rights reserved.
            </p>
