      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-8">
          <div className={`${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-green-500/30 bg-green-500/10 text-xs sm:text-sm text-green-300 mb-6">
              Revenue-First Growth Agency | Lusaka + Remote
            </div>
          ...
          >
            <p className="text-lg sm:text-xl text-foreground/70 leading-relaxed">
              Kinertic Media Arts helps ambitious teams turn strategy, content, and campaigns into
              measurable pipeline, bookings, and long-term brand equity.
            </p>
          </div>
          ...
          >
            {['200+ Projects Delivered', '50+ Active Clients', '98% Client Retention', 'Free 30-min Growth Audit'].map((item) => (
              <div
                key={item}
          ...
          >
            Get a practical 90-day action plan with channels, creative priorities, and budget focus.
          </p>
        </div>
      </div>
